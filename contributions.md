...
| **[@OrtakYakuza]** | [22.04.2025]    | [(https://github.com/zametrics/sopra-fs25-group-09-server/commit/b44239a079f5ee0534416f792e432d382272ad5a)]          | [Introduces logic and API endpoint for selecting the next painter within a lobby based on sequential rotation; adds `currentPainterToken` and `painterHistoryTokens` to `Lobby`, implements `selectNextPainter(lobbyId)` in service, and exposes `POST /lobbies/{lobbyId}/nextPainter`]     | [Ensures fair, cycle-based rotation of painters and accurate tracking of painting history so each player gets a turn per cycle.]     |
|                   | [23.04.2025/ 24.04.2025]    | [https://github.com/zametrics/sopra-fs25-group-09-client/commit/dd4287cb7f4c8498fd7a49ab24fc27fe7d14d6e2], [https://github.com/zametrics/sopra-fs25-group-09-client/commit/961581c54d21f8624552c797385e75f84b7f4bf5], [https://github.com/zametrics/sopra-fs25-group-09-client/commit/211407ec850ec0563f1a19ddbf1c3f7ecabd385f]          | [Unified lobby join & fetch flow; automatic next‐painter selection; persisted painter token and real‐time draw gating; visually distinguished drawer; canvas reset each round; restricted delete/undo to the painter.]     | [Improves lobby lifecycle with seamless join/fetch, fair painter rotation, clearer UI feedback, and secure drawing controls.]     |
                    | [25.04.2025]    | [https://github.com/zametrics/sopra-fs25-group-09-client/commit/5b52c0c776356c88a390385c0e4b12de141fad90]          | [After a correct guess, the chat input and send button are disabled (isChatDisabled set, input cleared and disabled prop applied).]     | [Prevents players from chatting once the word’s been guessed, avoiding spoilers and preserving game integrity.]     |
