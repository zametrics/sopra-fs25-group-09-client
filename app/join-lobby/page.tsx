  ...
  useEffect(() => {
    const fetchLobbies = async () => {
      ...
      try {
        ...
        setErrorMessage(
          "Could not load active lobbies. Please try again later."
        );
        setLobbies([]);
      } finally {
    ...
    const fetchOwnerUsernames = async () => {
      ...
      await Promise.all(
        uniqueOwnerIds.map(async (ownerId) => {
          try {
            const userRes = await apiService.get<{ username: string }>(
              `/users/${ownerId}`
            );
      ...
      <div className="settings-box join-lobby-container">
                  ...
                  <div key={lobbyCode} className="lobby-entry-container">
                    ...
                    <div className="lobby-list-actions">
                      ...
                      >
                        JOIN
                        <img
                          src="/icons/play_arrow_orange.svg"
                          alt=""
                          width={20}
                          height={20}
                          className="list-join-icon"
                        />
                      </Button>
                      <Button
                      ...
                      >
                        <img
                          src="/icons/visibility_pink.svg"
                          alt=""
                          width={20}
                          height={20}
                          className="list-spectate-icon"
                        />
                      </Button>
                    </div>
                  </div>
        ...
        <div className="roomcode-join-area">
          <Input
            ...
            onChange={(e) =>
              setLobbyCodeInput(e.target.value.replace(/\D/g, ""))
            }
          ...
          <Button
            ...
            className={`roomcode-join-button-bottom ${
              isRoomCodeValid ? "join-button-active" : "join-button-inactive"
            }`}
        ...
        <div className="pagination-controls">
          ...
          >
            <Image
              src={
                canGoPrev
                  ? "/icons/arrow_back_white.svg"
                  : "/icons/arrow_back_grey.svg"
              }
              alt="Previous"
              width={20}
              height={20}
          ...
          >
            ...
            <Image
              src={
                canGoNext
                  ? "/icons/arrow_forward_white.svg"
                  : "/icons/arrow_forward_grey.svg"
              }
              alt="Next"
              width={20}
              height={20}
